        ...
        <div id="main" className="alt">
            <section id="one">
                <div className="inner">
                    ...
                    <p>El edificio fue modelado en <b>Revit</b>, esto permitió anticiparse a interferencias que puedan surgir en la etapa de construcción y agilizar el desarrollo del proyecto.</p>
